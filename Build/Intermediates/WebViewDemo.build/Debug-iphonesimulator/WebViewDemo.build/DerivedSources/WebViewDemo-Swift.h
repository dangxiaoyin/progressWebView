...
SWIFT_CLASS("_TtC11WebViewDemo20CCWebViewSController")
@interface CCWebViewSController : UIViewController <UIActionSheetDelegate, WKNavigationDelegate, UIWebViewDelegate>
@property (nonatomic) NSURL * __nullable homeUrl;

/// 传入控制器、url、标题
+ (void)showWithContro:(UIViewController * __nonnull)contro withUrlStr:(NSString * __nonnull)url withTitle:(NSString * __nonnull)title;
- (void)viewDidLoad;
- (void)configUI;
- (void)configBackItem;
- (void)configMenuItem;
- (void)configColseItem;
- (void)backBtnPressed:(id __nonnull)sender;
- (void)menuBtnPressed:(id __nonnull)sender;
- (void)colseBtnPressed:(id __nonnull)sender;
- (void)actionSheet:(UIActionSheet * __nonnull)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex;
- (void)actionSheetPress:(NSInteger)buttonIndex;
